...
_G.packer_plugins = {
  ...
  ["cinnamon.nvim"] = {
    config = { "\27LJ\2\nˆ\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\5\18extra_keymaps\2\20default_keymaps\2\17scroll_limit\3d\rcentered\2\21extended_keymaps\1\nsetup\rcinnamon\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-cheat.sh"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/alex/.local/share/lunarvim/site/pack/packer/opt/nvim-cheat.sh",
  ...
  popfix = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/lunarvim/site/pack/packer/opt/popfix",
  ...
  ["tokyonight.nvim"] = {
    cond = { "\27LJ\2\n†\1\0\0\3\0\a\0\0206\0\0\0009\0\1\0'\2\2\0B\0\2\0029\1\3\0)\2\t\0\3\2\1\0X\1\b€9\1\3\0)\2\17\0\1\1\2\0X\1\4€6\1\4\0009\1\5\0019\1\6\1X\2\3€+\1\1\0X\2\1€+\1\2\0L\1\2\0\22time_based_themes\fbuiltin\tlvim\thour\a*t\tdate\aos\0" },
  ...
  ["trouble.nvim"] = {
    commands = { "Trouble" },
    config = { "\27LJ\2\n{\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\5\fpadding\1\25use_diagnostic_signs\2\15auto_close\2\14auto_open\2\vheight\3\n\nsetup\ftrouble\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'refactoring.nvim', 'typescript.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'refactoring.nvim', 'typescript.nvim'}, { ft = "typescript" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'cinnamon.nvim', 'zen-mode.nvim', 'asynctasks.vim', 'Comment.nvim', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'twilight.nvim', 'nvim-bqf', 'gitsigns.nvim', 'lsp_signature.nvim', 'instant.nvim', 'hop.nvim', 'refactoring.nvim', 'nvim-spectre', 'todo-comments.nvim', 'editorconfig-vim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufReadPost * ++once lua require("packer.load")({'nvim-dap-ui', 'symbols-outline.nvim', 'nvim-ts-context-commentstring', 'vim-matchup'}, { event = "BufReadPost *" }, _G.packer_plugins)]]
